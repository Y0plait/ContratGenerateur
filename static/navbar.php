<?php 
   /*
    * FILENAME: navbar.php
    * DESCRIPTION: navbar du générateur de contrat de partenariat commercial et des différents script dont celui pour le toggle du thème
    * AUTHOR: Anton M.
...
<script>
    ...
    // TODO: Fix function to toggle themes
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-info">
        <div class="container-fluid">
            <a class="navbar-brand" href="./">
                <img src="./static/contract-document-svgrepo-com.svg" alt="" width="40" height="34"
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                    <!-- Change le style du boutton dans la navbar en fonction de la page sur laquelle on est. -->
                        <a class="nav-link <?php echo ($_SERVER['PHP_SELF'] == "index.php") ? 'active" href="#">' : '" href="./index.php">'; ?> Acceuil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($_SERVER['PHP_SELF'] == "generateur.php") ? 'active" href="#">' : '" href="./generateur.php">' ?>Générateur</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($_SERVER['PHP_SELF'] == "preferences.php") ? 'active" href="#">' : '" href="./preferences.php">' ?>Préférences</a>
                    </li>
